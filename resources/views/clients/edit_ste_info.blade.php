...
@section('admin_section')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Mettre a jour Client</li>
                        <li class="breadcrumb-item" aria-current="page">Info Client</li>
                    </ul>
                </div>
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Mettre a Jour Client: <span class="uppercase"> {{ $nom }} </span></h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form action=" {{ route("clients.updateSteInfo") }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
