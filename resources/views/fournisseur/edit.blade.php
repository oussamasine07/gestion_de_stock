            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Mettre a Jour Un Fournisseur</li>
                    </ul>
                </div>
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Mettre a Jour Un Fournisseur</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input 
                                        type="text" 
                                        name="raison_social" 
                                        value="{{ $fournisseur->raison_social }}" 
                                        class="form-control" 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input 
                                        ...
                                        value="{{ $fournisseur->identifiant_fiscal }}"
                                    >
                                ...
                                <div class="form-group">
                                    ...
                                    <input 
                                        ...
                                        value="{{ $fournisseur->taxe_professionnelle }}"
                                    >
                                ...
                                <div class="form-group">
                                    ...
                                    <input 
                                        ...
                                        value="{{ $fournisseur->registre_commerce }}"
                                    >
